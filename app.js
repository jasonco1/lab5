...
//     let requestUrl = "https://api.unsplash.com/photos/random/?client_id=uBUvKsj_WDLPhsV9krxG2THDK04obMdbklHo7cp9HWo&featured=true&orientation=landscape";
...
//     let requestUrl = `https://api.unsplash.com/photos/random/?client_id=uBUvKsj_WDLPhsV9krxG2THDK04obMdbklHo7cp9HWo&featured=true&orientation=landscape&query=${keyword}`;
...
async function getRandomImage(keyword, count){
  return new Promise (function (resolve, reject) {
    let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=uBUvKsj_WDLPhsV9krxG2THDK04obMdbklHo7cp9HWo&featured=true&orientation=landscape&query=${keyword}`;
